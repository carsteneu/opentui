# Cold-import / TTFMF report — artifact `wave0-r3` (UNGÜLTIG / SUPERSEDED)

> Dieser historische Lauf darf nicht als Abnahmebeleg verwendet werden. Das
> damalige Gate entschied nur über den Median der Paarquoten, ohne Konfidenzgrenze
> und ohne gemeinsame Absicherung von `importMs` und TTFMF. Ersetzt durch
> `wave0-r4` mit reihenfolgestratifiziertem, familienweisem Bootstrap-Gate.
