...
> [`v0.5.6-perf.8`](https://github.com/carsteneu/opentui/releases/tag/v0.5.6-perf.8), based on
> upstream v0.5.9): cold start −75 % (time to first native frame), code streaming −83 % cold /
